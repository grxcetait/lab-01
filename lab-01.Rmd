...
This means that some of the values are NA so therefore, all of the values in the output are NA.
...
na.rm removes the NA values so the actual mean and median values can be calculated. 
...
Because the larger values in the data are probably significantly larger and this alters the median.
...
nations_free_admission <- select(visitors_with_nations,
                                 n_2021,
                                 n_2022,
                                 admission,
                                 nation)

mutate(nations_free_admission,
       total_visitors = n_2021 + n_2022)

view(nations_free_admission)
